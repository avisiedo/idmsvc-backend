...
func (w *ServerInterfaceWrapper) ListDomains(ctx echo.Context) error {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Rh-Insights-Request-Id")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Rh-Insights-Request-Id", valueList[0], &XRhInsightsRequestId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""})
		if err != nil {
...
func (w *ServerInterfaceWrapper) RegisterDomain(ctx echo.Context) error {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Rh-Idm-Registration-Token")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Rh-Idm-Registration-Token", valueList[0], &XRhIdmRegistrationToken, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true, Type: "string", Format: ""})
		if err != nil {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Rh-Idm-Version")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Rh-Idm-Version", valueList[0], &XRhIdmVersion, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true, Type: "string", Format: ""})
		if err != nil {
...
func (w *ServerInterfaceWrapper) DeleteDomain(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "uuid", ctx.Param("uuid"), &uuid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid"})
	if err != nil {
...
func (w *ServerInterfaceWrapper) HostConf(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "inventory_id", ctx.Param("inventory_id"), &inventoryId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid"})
	if err != nil {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "fqdn", ctx.Param("fqdn"), &fqdn, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "idn-hostname"})
	if err != nil {
